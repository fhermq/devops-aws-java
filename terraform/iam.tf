...
# NOTE: GitHub Actions role policy is managed manually via CLI to avoid conflicts:
# aws iam put-role-policy --role-name github-actions-ecr-role --policy-name github-actions-ecr-policy --policy-document file://github-actions-ecr-policy.json
# This prevents Terraform from overwriting manual policy updates.
# See SETUP.md for policy update instructions.
